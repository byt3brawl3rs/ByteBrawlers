...
const pulseTillDone = require('npm/lib/utils/pulse-till-done.js')
const readUserInfo = require('npm/lib/utils/read-user-info.js')
...
const BaseCommand = require('npm/lib/base-command.js')
