...
const log = require('npm/lib/utils/log-shim.js')

const reifyFinish = require('npm/lib/utils/reify-finish.js')

const ArboristWorkspaceCmd = require('npm/lib/arborist-cmd.js')
class Update extends ArboristWorkspaceCmd {
  ...
  static async completion (opts, npm) {
    const completion = require('npm/lib/utils/completion/installed-deep.js')
