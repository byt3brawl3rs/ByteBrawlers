...
const usage = require('npm/lib/utils/npm-usage.js')
const LogFile = require('npm/lib/utils/log-file.js')
const Timers = require('npm/lib/utils/timers.js')
const Display = require('npm/lib/utils/display.js')
const log = require('npm/lib/utils/log-shim')
const replaceInfo = require('npm/lib/utils/replace-info.js')
const updateNotifier = require('npm/lib/utils/update-notifier.js')
const pkg = require('npm/package.json')
const { deref } = require('npm/lib/utils/cmd-list.js')
