...
const { fileExists, localFileExists } = require('libnpmexec/lib/file-exists.js')
const getBinFromManifest = require('libnpmexec/lib/get-bin-from-manifest.js')
const noTTY = require('libnpmexec/lib/no-tty.js')
const runScript = require('libnpmexec/lib/run-script.js')
const isWindows = require('libnpmexec/lib/is-windows.js')
