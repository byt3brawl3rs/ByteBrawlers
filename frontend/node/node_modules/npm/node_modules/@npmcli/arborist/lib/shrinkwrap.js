...
const YarnLock = require('@npmcli/arborist/lib/yarn-lock.js')
const {
  readFile,
  readdir,
  readlink,
...
const specFromLock = require('@npmcli/arborist/lib/spec-from-lock.js')
const versionFromTgz = require('@npmcli/arborist/lib/version-from-tgz.js')
...
const { overrideResolves } = require('@npmcli/arborist/lib/override-resolves.js')
