...
const typeDefs = require('@npmcli/config/lib/type-defs.js')
const nerfDart = require('@npmcli/config/lib/nerf-dart.js')
const envReplace = require('@npmcli/config/lib/env-replace.js')
const parseField = require('@npmcli/config/lib/parse-field.js')
const typeDescription = require('@npmcli/config/lib/type-description.js')
const setEnvs = require('@npmcli/config/lib/set-envs.js')

const {
  ErrInvalidAuth,
} = require('@npmcli/config/lib/errors.js')
