...
const packageEnvs = require('@npmcli/run-script/lib/package-envs.js')
const { isNodeGypPackage, defaultGypInstallScript } = require('@npmcli/node-gyp')
const signalManager = require('@npmcli/run-script/lib/signal-manager.js')
