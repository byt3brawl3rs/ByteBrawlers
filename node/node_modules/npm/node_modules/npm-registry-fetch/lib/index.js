...
const { HttpErrorAuthOTP } = require('npm-registry-fetch/lib/errors.js')
const checkResponse = require('npm-registry-fetch/lib/check-response.js')
...
const defaultOpts = require('npm-registry-fetch/lib/default-opts.js')
...
module.exports.cleanUrl = require('npm-registry-fetch/lib/clean-url.js')
