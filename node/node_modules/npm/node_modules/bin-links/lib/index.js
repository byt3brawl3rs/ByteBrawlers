const linkBins = require('bin-links/lib/link-bins.js')
const linkMans = require('bin-links/lib/link-mans.js')
...
const shimBin = require('bin-links/lib/shim-bin.js')
const linkGently = require('bin-links/lib/link-gently.js')
const resetSeen = () => {
  shimBin.resetSeen()
  linkGently.resetSeen()
}

const checkBins = require('bin-links/lib/check-bins.js')
const getPaths = require('bin-links/lib/get-paths.js')
