...
const deepestNestingTarget = require('@npmcli/arborist/lib/deepest-nesting-target.js')
const CanPlaceDep = require('@npmcli/arborist/lib/can-place-dep.js')
const {
  KEEP,
  CONFLICT,
} = CanPlaceDep
...
const peerEntrySets = require('@npmcli/arborist/lib/peer-entry-sets.js')
