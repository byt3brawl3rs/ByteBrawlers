...
const Edge = require('@npmcli/arborist/lib/edge.js')
const Inventory = require('@npmcli/arborist/lib/inventory.js')
const OverrideSet = require('@npmcli/arborist/lib/override-set.js')
const { normalize } = require('read-package-json-fast')
const { getPaths: getBinPaths } = require('bin-links')
const npa = require('npm-package-arg')
const debug = require('@npmcli/arborist/lib/debug.js')
const gatherDepSet = require('@npmcli/arborist/lib/gather-dep-set.js')
...
const consistentResolve = require('@npmcli/arborist/lib/consistent-resolve.js')

const printableTree = require('@npmcli/arborist/lib/printable.js')
const CaseInsensitiveMap = require('@npmcli/arborist/lib/case-insensitive-map.js')

const querySelectorAll = require('@npmcli/arborist/lib/query-selector-all.js')
