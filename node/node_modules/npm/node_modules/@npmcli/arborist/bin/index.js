...
const { bin, arb: options } = require('@npmcli/arborist/bin/lib/options')
const version = require('@npmcli/arborist/package.json').version
...
for (const file of commandFiles) {
  ...
  commands[name] = () => {
    const timers = require('@npmcli/arborist/bin/lib/timers')
    const log = require('@npmcli/arborist/bin/lib/logging')
