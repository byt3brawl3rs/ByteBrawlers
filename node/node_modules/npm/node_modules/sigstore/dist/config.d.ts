import { CA } from 'sigstore/dist/ca';
import { Provider } from 'sigstore/dist/identity';
import { TLog } from 'sigstore/dist/tlog';
import { TSA } from 'sigstore/dist/tsa';
import * as sigstore from 'sigstore/dist/types/sigstore';
import type { FetchOptions, Retry } from 'sigstore/dist/types/fetch';
import type { KeySelector } from 'sigstore/dist/verify';
interface CAOptions {
    fulcioURL?: string;
}
