...
const isPackageBin = require('pacote/lib/util/is-package-bin.js')
const removeTrailingSlashes = require('pacote/lib/util/trailing-slashes.js')
const getContents = require('@npmcli/installed-package-contents')
const readPackageJsonFast = require('read-package-json-fast')
const readPackageJson = promisify(require('read-package-json'))
const { Minipass } = require('minipass')

const cacheDir = require('pacote/lib/util/cache-dir.js')
...
// Child classes
const GitFetcher = require('pacote/lib/git.js')
const RegistryFetcher = require('pacote/lib/registry.js')
const FileFetcher = require('pacote/lib/file.js')
const DirFetcher = require('pacote/lib/dir.js')
const RemoteFetcher = require('pacote/lib/remote.js')
