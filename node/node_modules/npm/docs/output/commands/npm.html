...
"blerg".  Check out <a href="npm-install.html"><code>npm install</code></a> for more
...
have to reinstall every time you make a change.  Use <a href="npm-link.html"><code>npm link</code></a> to do this.</li>
<li>install:
...
done via <a href="npm-install.html"><code>npm install</code></a></li>
<li>adduser:
Create an account or log in.  When you do this, npm will store
credentials in the user config file.</li>
<li>publish:
Use the <a href="npm-publish.html"><code>npm publish</code></a> command to upload your
...
parsed if it is found.  See <a href="npm-prefix.html"><code>npm prefix</code></a> for
